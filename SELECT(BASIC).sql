...
WHERE SUBSTR(STUDENT_SSN,8,1)=2 AND ABSENCE_YN = 'Y' AND D.DEPARTMENT_NO = '001';
...
SELECT STUDENT_NO, STUDENT_NAME, STUDENT_SSN FROM TB_STUDENT
    WHERE EXTRACT(YEAR FROM ENTRANCE_DATE) = 2002 AND STUDENT_ADDRESS LIKE '전주시%' AND ABSENCE_YN = 'N';
